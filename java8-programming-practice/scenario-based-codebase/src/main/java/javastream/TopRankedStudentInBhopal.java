...
public class TopRankedStudentInBhopal {
	public static void main(String[] args) {
		...
		students.stream().filter(s->s.city.equalsIgnoreCase("Bhopal"))
		.min(Comparator.comparing(s->s.rank)).ifPresent(stu->System.out.println(stu));
	}
}
