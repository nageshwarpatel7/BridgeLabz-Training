...
public class BhopalYoungStudent {
	public static void main(String[] args) {
		...
		students.stream().filter(s->s.city.equalsIgnoreCase("Bhopal")).min(Comparator.comparing(s->s.age))
		.ifPresent(stu->System.out.println(stu));
	}
}
