...
public class SortByNameAndRank {
	public static void main(String[] args) {
		...
		student.stream().sorted(Comparator.comparing((Student s)->s.firstName)
				.thenComparingInt((Student s)->s.rank)).forEach(System.out::println);
	}
}
