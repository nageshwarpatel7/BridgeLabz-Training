...
public class StudentNameCityWise {
	public static void main(String[] args) {
		...
		Map<String, List<String>> studentsCityWise = students.stream()
								.collect(Collectors.groupingBy(s->s.city, 
										Collectors.mapping(s->s.name, Collectors.toList())));
		
		studentsCityWise.forEach((city, names)-> System.out.println(city+" -> "+names));
	}
}
