...
public class StudentNotBelongToBhopal {
	public static void main(String[] args) {
		...
		boolean ans = students.stream().noneMatch(s->s.city.equalsIgnoreCase("Bhopal"));
		System.out.println("No student belongs to: "+ans);
	}
}
