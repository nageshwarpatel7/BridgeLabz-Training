...
public class FemaleAverageAge {
	public static void main(String[] args) {
		...
		OptionalDouble avgAge =students.stream()
		.filter(s->s.gender.equalsIgnoreCase("M")).mapToInt(s->s.age).average();
		
		avgAge.ifPresent(age->System.out.println("Average age of female students: "+age));
	}
}
