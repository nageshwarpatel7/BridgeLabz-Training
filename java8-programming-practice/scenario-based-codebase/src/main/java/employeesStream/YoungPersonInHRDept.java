...
public class YoungPersonInHRDept {
	public static void main(String[] args) {
		...
		employees.stream().filter(e->e.getDept().equalsIgnoreCase("HR"))
		.min(Comparator.comparing(Employees::getAge)).ifPresent(s->System.out.println(s));
	}
}
