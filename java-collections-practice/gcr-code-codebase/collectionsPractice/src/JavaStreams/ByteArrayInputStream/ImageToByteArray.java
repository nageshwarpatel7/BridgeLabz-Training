...
public class ImageToByteArray {
	public static void main(String[] args) {
		File originalImage = new File("src//collections//JavaStreams//ByteArrayInputStream/test.jpg");
		File copiedImage = new File("src//collections//JavaStreams//ByteArrayInputStream/output.jpg");
