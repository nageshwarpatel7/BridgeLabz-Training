...
- Parsed rows using:
  - `String.split()`
  - `CsvToBean` (CSV → Java Object mapping)
...
- Created JSON objects and arrays
- Converted:
  - Java Objects → JSON
  - JSON → Java Objects
...
## 🧮 Section C – LeetCode-Based Problems
🚧 *In progress*

---

## ✅ Skills Gained (Week 4)
- Java I/O Streams
- Java Collections Framework
- CSV parsing, validation, and optimization
- JSON parsing, mapping, and schema validation
